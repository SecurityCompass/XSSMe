 ...
 * Usage:
 *
 * var newJSONString = JSON.stringify( GIVEN_JAVASCRIPT_OBJECT );
 * var newJavaScriptObject = JSON.parse( GIVEN_JSON_STRING );
 *
...
// * An optional key blacklist has been added to JSON.stringify

// If canonical parser is installed, don't bother
